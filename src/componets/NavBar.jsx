  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-start mx-auto'>
        ...
        >
          <p className='text-white text-[26px] lg:text-[36px] font-bold pointer-events-auto cursor-pointer flex !pl-8'>
            SB
          </p>
        </Link>

        <ul className='list-none hidden sm:flex flex-col gap-5 !pr-8'>
          {navLinks.map((nav) => (
            <li
              key={nav.id}
